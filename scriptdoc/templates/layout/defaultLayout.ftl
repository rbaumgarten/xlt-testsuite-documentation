    ...
    <div class="container">
      <div id="main" class="row">
          <#if sidebar?has_content>
              <div class="col s3" id="nav-column">
                  <div class="sidebar-wrapper">
                      <#noescape>${sidebar}</#noescape>
                  </div>
              </div>
              <div class="col s8 offset-s1" id="content-root">
          <#else>
    ...
    <div id="footer">
      <div class="container">
        <div class="row red darken-4 z-depth-1">
          <div class="footer-copy white-text">Generated with Xceptance LoadTest&reg;&nbsp;<span class="product-version">${xlt_version}</span>.</div>
        </div><!-- /.row -->
      </div><!-- /.container -->
    </div><!-- /#footer -->
  </footer>
