...
There are also some __global modules__ (for interactions with elements in header, footer or naviagtion) and __helper modules__ (enabling text conversions for example).
